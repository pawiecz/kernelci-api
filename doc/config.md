...
* [Image data (overlays, scripts)](https://github.com/kernelci/kernelci-core/tree/main/config/rootfs)
* [Buildroot fork (used for `baseline` images)](https://github.com/kernelci/buildroot)
* [Builds configuration](https://github.com/kernelci/kernelci-core/blob/main/config/core/rootfs-configs.yaml)
